...
D=2048; THEMES=128; UNITS=64; BUDGET=140; ROOT=Path('/mnt/data/hng_doc_scale')
...
def main():
 ...
 Path('/mnt/data/hng-frontier-0.4.0a1/benchmarks/DOCUMENT_SCALE.json').write_text(json.dumps(out,indent=2)); print(json.dumps(out,indent=2))
