...
root=Path('/mnt/data/hng_frontier_03_stream'); shutil.rmtree(root,ignore_errors=True)
lat=[]
...
Path('/mnt/data/hng-frontier-0.3.0a1/benchmarks/TURN_STREAM.json').write_text(json.dumps(res,indent=2,sort_keys=True))
