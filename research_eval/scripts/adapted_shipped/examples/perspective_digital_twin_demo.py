...
root=Path('C:\\Python310\\hng-frontier-0.5.1a1-release\\hng-frontier-0.5.1a1-release\\research_eval\\run_data\\example_perspective'); shutil.rmtree(root,ignore_errors=True)
