...
D=2048; CONTEXTS=128; VARIANTS=16; ACTION_FAMILIES=256; ROOT=Path('C:\\Python310\\hng-frontier-0.5.1a1-release\\hng-frontier-0.5.1a1-release\\research_eval\\run_data\\assistant_ablation')
...
def main():
 ...
 Path('C:\\Python310\\hng-frontier-0.5.1a1-release\\hng-frontier-0.5.1a1-release\\research_eval\\raw\\assistant_ablation.results.json').write_text(json.dumps(out,indent=2)); print(json.dumps(out,indent=2))
